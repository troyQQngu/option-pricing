...
title('Cauchy Random Samples Generated by Inverse Transformation VS Scaled Theoretical Density Function',FontSize = 12)
%% 6a
% generate uniform random variables
U_6 = rand(100000,1);
...
hold on
plot(G_x,350*G_y)
title('Marsagalia-Bray Method VS Scaled Theoretical Gaussian pdf',FontSize = 12)
%% 6c
...
hold on 
plot(G_x,350*G_y)
title('"randn(100000,1)" VS Scaled Theoretical Gaussian pdf',FontSize = 12)
